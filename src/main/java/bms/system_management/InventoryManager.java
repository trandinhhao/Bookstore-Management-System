...
public class InventoryManager {
    ...
    public static InventoryManager getProductById(int productId) throws SQLException, ClassNotFoundException {
    ...
    public static ArrayList<InventoryManager> getAllProducts() throws SQLException, ClassNotFoundException {
    ...
    public void updateQuantity(int change) throws SQLException, ClassNotFoundException {
        Connection conn = ConnectMySQL.getConnection();
    ...
    public static List<InventoryManager> getLowStockProducts(int threshold) throws SQLException, ClassNotFoundException {
        Connection conn = ConnectMySQL.getConnection();
