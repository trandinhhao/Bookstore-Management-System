...
public class Promotion {
    ...
    public static PreparedStatement getprepareStatement(String sqlString) throws SQLException, ClassNotFoundException {
    ...
    public static Promotion getByID(int id) throws SQLException, ClassNotFoundException {
    ...
    public static ArrayList<Promotion> getAll() throws SQLException, ClassNotFoundException {
