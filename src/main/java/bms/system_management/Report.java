...
public class Report {
    ...
    public ArrayList<Report> getAllRepor() throws SQLException{
    ...
    public static Report generateInventoryReport() throws SQLException {
    ...
    public static Report generateSalesReport(Date startDate, Date endDate) throws SQLException {
        Connection conn = ConnectMySQL.getConnection();
        StringBuilder content = new StringBuilder();
